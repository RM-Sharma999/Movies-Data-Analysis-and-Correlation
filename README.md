...
This project explored key factors influencing a movie’s **commercial success** using data analysis and visual storytelling. By examining the relationships between **budget, gross revenue, IMDb scores, votes, production companies**, and more, we uncovered several valuable insights.
...
**Production companies** have a significant impact on revenue outcomes and shows how **yearly trends** reflect shifting market dynamics. These insights can help filmmakers, producers, and analysts in making **data-driven decisions** to improve performance and reduce risk in future projects.
